var jsPsychTimeSliderBinary = (function (jspsych) {
    'use strict';
...
function displayFeedbackCorrect() {
    ...
    var sliderWidth = display_element.querySelector('#plugin-time-slider-response-response').offsetWidth;
    console.log("sliderWidth = ", display_element.querySelector('#plugin-time-slider-response-response').offsetWidth);
...
console.log("outputWidth: ", outputWidth)
      ...
      console.log("horizontalPosition auto: ", horizontalPosition);
      console.log("horizontalPosition manual: ", (500-168)/2);
